...
- Photorealistic generated practitioner, service scene, or interior for a personal / single-location service business (hairdresser, salon, dentist, therapist, small clinic, single-practitioner consultancy, solo studio). The reader reads the imagery as the actual practitioner or premises, which misrepresents. Required correction: re-pick toward P5 Abstract Texture / P7 Illustrated Editorial / P8 Diagrammatic, or heavily stylize (painted, strongly color-graded, or macro crops with no full scene), or route to a `[NEEDS: client-supplied photo]` content marker. See the Business-type safety check in `.claude-plugin/skills/design-system/references/visual-vocabulary.md`.
