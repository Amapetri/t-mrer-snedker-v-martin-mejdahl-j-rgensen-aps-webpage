...
All imagery the pipeline produces is AI-generated (see the media-prompting skill's "Core assumption — AI generation only"). The P-strategies describe *visual grammar*, not production method — but that production-method constraint changes which strategies are *safe* for which businesses.

### Business-type safety check (read before selecting)

The reader interprets imagery through the lens of what the page claims the business is. For some businesses, the page context implicitly asserts "this is us / our place / our practitioner" about any human or facility imagery. Photorealistic generation in those contexts creates a false identity claim.

Classify the business into one of three buckets before picking a P-strategy:

- **Personal / single-location service** — customer books with a specific practitioner or visits a specific physical place (hairdresser, barber, salon, dentist, therapist, massage, small clinic, single-practitioner consultancy, independent restaurant, independent studio, personal trainer, solo photographer). The reader's default interpretation of any human/facility imagery is "this is THEM / their place."
  - **Safe primary:** P5 Abstract Texture (tools/materials only), P7 Illustrated Editorial, P8 Diagrammatic.
  - **Avoid photorealistic human/space strategies as primary:** P2 Environmental Portrait, P3 Process Documentary with practitioner in frame, P6 Architectural Interior of treatment/service space. These will read as documentary and misrepresent.
  - **If the real practitioner or real premises is what the page needs,** route it to `[NEEDS: client-supplied photo ...]` — not a manifest row.
  - A brief that lands on a photorealistic P-strategy here must either re-pick toward P5/P7/P8, or commit to heavy stylization (painted/illustrated treatment, dramatic color-grade, or macro/texture cropping that never shows a full scene) so the imagery reads as deliberate art, not documentation. Unstyled photorealism is not acceptable for this bucket.

- **Multi-location / multi-practitioner / larger service firm** — customer relationship is with a brand, not a specific person or place (chain of clinics, 50-person consultancy, multi-office professional services). Representative imagery is culturally understood. P2/P3/P6 are available, but specific *named* individuals and specific *real* premises still route to `[NEEDS: client-supplied ...]` per the media-prompting skill.

- **Product, capability, or industrial business** — customer buys a product or contracts a capability (manufacturing, engineering, software, heavy industry, trade services, B2B tooling, logistics, construction). Representative imagery is the norm across all P-strategies — including photorealistic P2/P3/P6 — because the imagery's role is to evoke *kind of work*, not prove *who or where*.

When in doubt between personal-service and something else: apply the practitioner-or-place test. If the customer's mental model of the business centers on a specific practitioner or a specific location, treat as personal-service. The cost of an abstract strategy is almost never misrepresentation; the cost of a photorealistic strategy in a personal-service context is.
...
- Generated figures read as representative, not as specific real people
- Feels: authenticity, trust, human
- Fits: Services where the humans are the product (consulting, architecture, specialized trades) — at a scale where the reader does not expect "this is our specific named team"
- **Danger:** In personal-service / single-practitioner contexts (hairdresser, therapist, dentist, solo consultant), readers will assume the figure *is* the practitioner. Do not select as primary for that bucket — see Business-type safety check above. Route specific-real-person needs to `[NEEDS: client-supplied photo ...]`.
...
- **Danger:** If the process shown is service-delivery to a customer (haircut in progress, dental procedure, therapy session), the imagery implies documentary evidence of a real session with a real customer. For personal-service businesses, prefer P5 or P7, or constrain P3 to tools/materials in hand with no identifiable customer or practitioner.
...
- **Danger:** For single-location personal-service businesses (one salon, one clinic, one studio), a generated interior reads as the actual premises and misrepresents. Prefer P5 Abstract Texture or route real-premises shots to `[NEEDS: client-supplied photo]`.
